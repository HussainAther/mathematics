...
of the Hessian (hessian) matrix H in which i, j are included in the set {1,...W} in which W is the 
...
Its inverse is used to determine the predic- tive distribution for a trained network,
