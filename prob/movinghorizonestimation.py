...
"""
Moving horizon estimation (MHE) is an optimization approach that uses a series of measurements
observed over time containing noise and other inaccuracies. It produces estimates of unknown variables
or parameters and requires an iterative approach that relies on linear programming or nonlinear programming
